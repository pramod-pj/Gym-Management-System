        ...
        <div class="widget-content nopadding">
          <form action="add-member-req.php" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" required class="span11" name="username" placeholder="Username" />
              </div>
            </div>
            <div class="control-group">
          ...
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <input type="number" id="mask-phone" name="contact" placeholder="9876543210" minlength=10 class="span8 mask text" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required />
